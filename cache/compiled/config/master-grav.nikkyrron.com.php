...
return [
    ...
    'checksum' => '5a419d32d07d034ca788b854689cb3d5',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'themes/vela' => [
                'file' => 'user/config/themes/vela.yaml',
                'modified' => 1558463608
            ]
        ],
        'system/config' => [
...
node_modules'
        ...
        'themes' => [
            'vela' => [
                'enabled' => true,
                'title_in_menu' => '<div style=\'font-size: 25px\'>NikkyRon<br>KnowledgeBase</div><span style=\'font-size: 50px;padding-top:7px;\'>2</span>',
